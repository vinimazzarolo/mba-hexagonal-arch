...
import br.com.fullcycle.hexagonal.application.usecases.InMemoryTicketRepository;
...
class SubscribeCustomerToEventUseCaseTest {
    ...
    public void testReserveTicket() throws Exception {
        ...
        final var aCustomer = Customer.newCustomer("Vini Doe", "123.456.789-01", "vini.doe@gmail.com");
